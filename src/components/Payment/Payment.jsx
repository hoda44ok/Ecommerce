        ...
        <div className="py-20">
            <div className="container mx-auto">
                <form className="max-w-7xl md:mx-44 mx-0 p-5">
                    ...
                    <div className="flex flex-row sm:flex-row items-center sm:justify-start gap-3 w-full">
                        <button
                            onClick={cashPayment}
                            className="bg-teal-700 border hover:border-teal-700 hover:bg-white hover:text-teal-700 text-white font-medium rounded-lg text-lg w-[40%]  px-4 py-2 text-center transition duration-200 dark:bg-teal-800 dark:border-teal-700 dark:hover:bg-teal-700 dark:hover:text-white"
                        >
                            {isLoading ? <i className="fa-solid fa-spin fa-spinner text-white"></i> : "Pay Now"}
                        </button>

                        <button
                            onClick={onlinePayment}
                            className="bg-blue-700 border hover:border-blue-700 hover:bg-white hover:text-blue-700 text-white font-medium rounded-lg text-lg w-[40%]  px-4 py-2 text-center transition duration-200 dark:bg-blue-800 dark:border-blue-700 dark:hover:bg-blue-700 dark:hover:text-white"
                        >
                            {isLoadingOnline ? <i className="fa-solid fa-spin fa-spinner text-white"></i> : "Pay Online"}
                        </button>
                    </div>
